...
import { IdeaOutputSchema, IdeaOutputJsonSchema } from "@/lib/ai/prompts/schemas";
 ...
 */
async function callLLM(provider: Provider, systemPrompt: string, userPrompt: string, model: string): Promise<string> {
